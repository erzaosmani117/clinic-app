            ...
            <div className="max-w-6xl mx-auto px-6 py-10">
                ...
                <div className="mb-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                    <button
                        ...
                        className="text-slate-500 hover:text-slate-700 text-sm flex items-center gap-1 mb-3 transition"
                    >
                        ← Back to categories
                    </button>
                ...
                {!loading && !error && (
                    <div className="relative mb-6">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-3 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition bg-white shadow-sm"
                        />
                        {search && (
                            <button
                                onClick={() => setSearch('')}
                ...
                {loading ? (
                    <div className="space-y-3">
                        {[...Array(5)].map((_, i) => (
                            <div key={i} className="bg-white rounded-2xl border border-gray-200 p-5 animate-pulse shadow-sm">
                    ...
                    <div className="space-y-3">
                        {filteredDrugs.map((drug) => (
                            <button
                                ...
                                className="w-full bg-white rounded-2xl border border-slate-200 p-5 text-left hover:shadow-lg hover:border-blue-200 transition-all duration-200 group"
                            >
