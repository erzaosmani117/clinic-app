        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <nav className="bg-[#0a1628] shadow-lg">
                <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <button onClick={() => navigate(`/dosage/category/${drug?.category_id}`)} className="text-white/70 hover:text-white text-sm transition">
                            ← Back
                        </button>
                        <button onClick={() => navigate('/dosage/history')} className="text-white/70 hover:text-white text-sm transition">
                            History
                        </button>
                    </div>
                </div>
